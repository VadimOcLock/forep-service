...
3. Отчёт №4 - Сведения об инвестициях в нефинансовые активы
4. Отчёт №10 - Сведения о доходах и расходах
5. Отчёт №11 - Сведения о затратах на производство
...
Возвращает значение суммы численности персонала `FqrModel04.zpersQty` балансовых единиц по указанному типу показателя.
