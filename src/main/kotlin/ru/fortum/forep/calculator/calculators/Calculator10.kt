...
class Calculator10: BaseCalculator() {
    // region api
    override fun calculate(_calcBuilder: CalculationBuilder,
                           ...
                           stream: ByteArrayInputStream):List<ru.fortum.forep.calculator.models.CalculationResult>
    {
        ...
        calcBuilder!!.fqr10.init(_settings.template.businessUnits)
